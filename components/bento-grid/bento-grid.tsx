...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="https://creditcards.chase.com/K800-058/images/preferred_card_DT.png"
          alt="avatar"
          height="100"
          width="100"
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <Image
          src="https://cdn.wallethub.com/common/product/images/creditcards/500/revenued-business-card-0027929c.jpg"
          alt="avatar"
          height="100"
          width="100"
          className="full h-15 w-25"
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          Your application was received, do you mind submitting your Drivers License again? The last one came out blurry.
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Sure! Here you go!</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
...
const items = [
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Customize the end user experience with your color pallet, logo, and domain email.
      </span>
    ),
...

  {
    ...
    description: (
      <span className="text-sm">
        Full customer support and servicing powered by <a href="https://rok.financial"> Rok Financial.</a>
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
